...
// ============================================
$pageTitle = "Đánh giá - NHÓM 10 Fashion Shop";
$additionalCSS = ['./assets/css/vote.css'];
$additionalJS = ['./assets/js/index.js'];

include("./includes/head.php");

// Chỉ cho phép admin truy cập
if (!isset($_SESSION['auth_user']['id']) || $_SESSION['auth_user']['role_as'] != 1){
    die("Từ chối truy cập - Chỉ dành cho admin");
}
$id = $_GET['id'];

include("./includes/body_start.php");
?>
        ...
        <div class="container">
            <div class="box">
                <div class="breadcumb">
                    ...
                    <a href="./index.php?page=cart">Giỏ hàng của tôi</a>
                    <span><i class='bx bxs-chevrons-right'></i></span>
                    <a href="./index.php?page=cart-status">Giỏ hàng đã mua</a>
                    <span><i class='bx bxs-chevrons-right'></i></span>
                    <a href="#">Đánh giá</a>
                </div>
            </div>
            ...
            <div class="box" style="padding: 0 40px">
                ...
                ?>
                    <p style="font-size: 20px; text-align: center;">
                      Mặt hàng này chưa thể vote <a style="color: blue; text-decoration: underline" href="./index.php?page=cart-status">Trở lại</a>  
                    </p>
                <?php 
                    } else { 
                ...
                <form class="form-vote" method="post" action="./pages/ordercode.php">
                    <div class="rate-form">
