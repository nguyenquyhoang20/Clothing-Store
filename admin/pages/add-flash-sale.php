<?php
$pageTitle = "Thêm flash sale - Admin NHÓM 10";
                    ...
                    <form action="code.php" method="POST">
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" step="0.01" min="0" name="discount_value" class="form-control" placeholder="Ví dụ: 10 hoặc 50000" required>
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" min="0" name="max_quantity" class="form-control" placeholder="Để trống nếu không giới hạn">
                            </div>
                        ...
                        <button type="submit" name="add_flash_sale_btn" class="btn bg-gradient-primary">
